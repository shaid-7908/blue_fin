...
function Card() {
  return (
    ...
    <div className='max-w-[1240px] mx-auto '>
        ...
        <h2 className='text-white md:text-5xl font-bold font-popins my-2'>
        We specilize in investing with technology startups 
        </h2>
        <p className='text-white font-popins'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea praesentium voluptas sapiente recusandae nisi molestias asperiores, earum deserunt, repellendus quia quasi consequatur a atque illum blanditiis ullam natus impedit obcaecati!</p>
    ...
    <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 my-4'>
      <div>
        ...
        <p className='text-white font-popins text-xl'>Securing the technology sector</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className='text-white font-popins text-xl'>Rethinking education</p>
      </div>
    </div>
  </div>
  )
