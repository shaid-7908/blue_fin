...
function Navbar() {
  ...
  return (
    <div className='flex md:flex-col justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white uppercase '>
      ...
      <h1 className=' text-base font-bold text-gold-theme'>BLUEFIN GOLD GROUP .</h1>
      </div>
      <motion.ul initial={{opacity:0,y:-20}} whileInView={{opacity:1,y:0}} viewport={{once:true}}  transition={{duration:0.4}} className='hidden md:flex md:font-semibold'>
