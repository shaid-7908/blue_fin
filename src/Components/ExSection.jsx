        ...
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col justify-center ">
            ...
            >
              ...
              minus blanditiis, optio iusto repudiandae quos nesciunt est
              reprehenderit corrupti praesentium molestias perferendis. Iusto
              quo minima voluptatem nemo odio rerum provident.
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 40 }}
              viewport={{ once: true }}
